...
MySQL - 5.6.26-enterprise-commercial-advanced-log : Database - pms
*********************************************************************
*/
...
/*Table structure for table `tq_admin` */
...
/*Table structure for table `tq_admin_channel` */

DROP TABLE IF EXISTS `tq_admin_channel`;
...
/*Data for the table `tq_admin_channel` */

/*Table structure for table `tq_admin_check` */

DROP TABLE IF EXISTS `tq_admin_check`;
...
/*Data for the table `tq_admin_check` */
...
/*Table structure for table `tq_admin_depart` */

DROP TABLE IF EXISTS `tq_admin_depart`;
...
CREATE TABLE `tq_advert` (
  ...
  `weights` int(10) DEFAULT NULL COMMENT '权重',
  `clicks` int(10) NOT NULL COMMENT '点击次数',
  `show_times` int(10) DEFAULT NULL COMMENT '展现次数',
...
CREATE TABLE `tq_advert_slot` (
  ...
  `remain` int(10) DEFAULT NULL COMMENT '停留时间',
...
CREATE TABLE `tq_article` (
  ...
  `depart_id` int(10) DEFAULT NULL COMMENT '录入部门',
  `check_id` int(10) DEFAULT NULL COMMENT '审核人员ID',
  `site_id` int(10) NOT NULL COMMENT '站点ID',
  ...
  `role_id` int(10) DEFAULT NULL COMMENT '审核角色ID',
...
CREATE TABLE `tq_channel` (
  ...
  `site_id` int(10) NOT NULL COMMENT '站点ID',
  `parent_id` int(10) DEFAULT NULL COMMENT '父栏目ID',
  ...
  `flow_id` int(10) DEFAULT NULL COMMENT '工作流ID',
...
CREATE TABLE `tq_comment` (
  ...
  `user_id` int(10) DEFAULT NULL COMMENT '用户ID',
  `parent_id` int(10) DEFAULT NULL COMMENT '评论ID',
...
CREATE TABLE `tq_company_info` (
  ...
  `com_nature` int(10) DEFAULT NULL,
  `com_scale` smallint(5) DEFAULT NULL,
  `com_industry1` int(10) DEFAULT NULL,
  `com_industry2` int(10) DEFAULT NULL,
  ...
  `apply_type` int(10) DEFAULT NULL,
...
CREATE TABLE `tq_consul` (
  ...
  `article_id` int(10) NOT NULL,
  `consul_user` int(10) DEFAULT NULL,
...
CREATE TABLE `tq_depart` (
  ...
  `flow_id` int(10) DEFAULT NULL COMMENT '当前采用的工作流',
...
CREATE TABLE `tq_edu_exp` (
  ...
  `degree` smallint(5) DEFAULT NULL COMMENT '学位',
...
CREATE TABLE `tq_evaluate` (
  ...
  `article_id` int(10) NOT NULL,
  `evaluate_user` int(10) DEFAULT NULL,
  `reply_user` int(10) DEFAULT NULL,
  `site_id` int(10) NOT NULL,
...
CREATE TABLE `tq_forum` (
  ...
  `last_theme_id` int(10) DEFAULT NULL COMMENT '最后回复主题',
  `last_replyer_id` int(10) DEFAULT NULL COMMENT '最后回复用户',
...
CREATE TABLE `tq_job_intent` (
  ...
  `industry_id` int(10) DEFAULT NULL COMMENT '期望从事行业',
  ...
  `metier_id2` int(10) DEFAULT NULL,
...
CREATE TABLE `tq_lang_ability` (
  ...
  `literacy` smallint(5) DEFAULT NULL,
  `communications` smallint(5) DEFAULT NULL,
...
CREATE TABLE `tq_personal_info` (
  ...
  `educational` smallint(5) DEFAULT NULL,
  `special_id` int(10) DEFAULT NULL,
...
CREATE TABLE `tq_personal_info_ext` (
  `personal_id` int(10) NOT NULL,
  `card_type` smallint(5) DEFAULT NULL,
  `idcard` varchar(50) DEFAULT NULL,
  `address` varchar(100) DEFAULT NULL,
  `commun_type1` smallint(5) DEFAULT NULL,
  `commun1` varchar(30) DEFAULT NULL,
  `commun_type2` smallint(5) DEFAULT NULL,
  `commun2` varchar(30) DEFAULT NULL,
  `marriage` smallint(5) DEFAULT NULL,
...
CREATE TABLE `tq_posts` (
  ...
  `creater_id` int(10) DEFAULT NULL COMMENT '发帖会员',
  ...
  `quote_id` int(10) DEFAULT NULL COMMENT '引用帖子ID',
...
CREATE TABLE `tq_posts_ext` (
  ...
  `editer_id` int(10) DEFAULT NULL COMMENT '修改会员ID',
...
CREATE TABLE `tq_question_detail` (
  ...
  `user_id` int(10) DEFAULT NULL COMMENT '投票会员ID',
...
CREATE TABLE `tq_site_config` (
  ...
  `reg_min` int(10) DEFAULT NULL COMMENT '会员名最小长度',
  `reg_max` int(10) DEFAULT NULL COMMENT '会员名最大长度',
  `reg_check` bit(1) NOT NULL COMMENT '注册会员是否需审核',
  `login_count` int(10) DEFAULT NULL COMMENT '每天登录失败次数限制',
  PRIMARY KEY (`config_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tq_survey_detail` (
  `detail_id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT NULL COMMENT '反馈会员ID',
...
CREATE TABLE `tq_survey_theme` (
  ...
  `total_count` int(10) DEFAULT NULL COMMENT '最大选项个数',
  `maxlength` int(10) DEFAULT NULL COMMENT '最大长度',
  `show_type` int(10) DEFAULT NULL COMMENT '显示形式',
  `priority` int(10) NOT NULL COMMENT '排序',
...
CREATE TABLE `tq_theme` (
  ...
  `creater_id` int(10) DEFAULT NULL COMMENT '发帖会员',
  `last_replyer_id` int(10) DEFAULT NULL COMMENT '最后回复会员',
...
CREATE TABLE `tq_work_exp` (
  ...
  `com_nature` int(10) DEFAULT NULL COMMENT '公司性质',
  `com_industry` int(10) DEFAULT NULL COMMENT '公司行业',
